...
main = do
  ...
  print allAuthors
  newAuthorId <- createAuthor "One" "Two" newSourceId c
  print newAuthorId
  newAuthor <- readAuthor c newAuthorId
  print newAuthor
  updateAuthor newAuthorId "One1" "Two1" newSourceId c
  ...
  print emptyAuthor
  newAuthorId <- createAuthor "One1" "Two1" newSourceId c
  putStrLn "Author end"
  ...
  print allTextInfo
  newTextInfoId <- createTextInfo "about me" "Hi! It's me" newSourceId c
  print newTextInfoId
  newTextInfo <- readTextInfo c newTextInfoId
  print newTextInfo
  updateTextInfo newTextInfoId "textInfoId" "..." newSourceId c
  ...
  newSourceTermsId <- createSourceTerms "Some3..." "someText" newSourceId c
  print newSourceTermsId
  newSourceTerms <- readSourceTerms c newSourceTermsId
  print newSourceTerms
  updateSourceTerms newSourceTermsId "Some4..." "someText2" newSourceId c
